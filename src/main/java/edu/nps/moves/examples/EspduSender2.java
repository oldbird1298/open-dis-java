...
public class EspduSender2 {
    ...
    public static void main(String args[]) {
        ...
        EspduSender.NetworkMode mode = EspduSender.NetworkMode.BROADCAST;
        ...
        try {
            ...
            if (networkModeString != null) {
                if (networkModeString.equalsIgnoreCase("unicast"))
                    mode = EspduSender.NetworkMode.UNICAST;
                else if (networkModeString.equalsIgnoreCase("broadcast"))
                    mode = EspduSender.NetworkMode.BROADCAST;
                else if (networkModeString.equalsIgnoreCase("multicast")) {
                    mode = EspduSender.NetworkMode.MULTICAST;
        ...
        entityID.setSiteID(1);  // 0 is apparently not a valid site number, per the spec
        entityID.setApplicationID(100);
        entityID.setEntityID(1008);
...
//        entityType.setCountry(82);              // Greece
        ...
        entityType.setSpecific((short) 10);            // M1A2 Abrams

        //Set alternative entity type
        entityType.setExtra((short) 0);
        alternativeEntityType.setEntityKind((short) 1);
        alternativeEntityType.setDomain((short) 2);
        alternativeEntityType.setCountry((short) 225);
        alternativeEntityType.setCategory((short) 1);
        alternativeEntityType.setSubcategory((short) 3);
        alternativeEntityType.setSpecific((short) 10);

        EntityMarking entityMarking = espdu.getMarking();
        entityMarking.setCharacterSet((short)1);
        entityMarking.setCharacters("F-16D BLK50".getBytes());
